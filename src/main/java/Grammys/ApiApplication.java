...
public class ApiApplication {
	...
	public static void main(String[] args) {
		...
		System.out.println(" EJERCICIO 1: NACIMIENTO DE LOS OBJETOS ");
		...
		System.out.println(" EJERCICIO 2: EQUIPAMIENTO CONDICIONAL ");
		...
		System.out.println(" EJERCICIO 3: LLENANDO EL INVENTARIO ");
		...
		System.out.println("Inventario de " + p1.getNombre() + ":");

		for (Arma arma : p1.getArmaDelPeleador()) {

			System.out.println("- " + arma.getNombre() + " | daño: " + arma.getBonificadorDanio());

		}

		System.out.println(" EJERCICIO 4: BUSCANDO EL MEJOR ATAQUE ");
		...
		System.out.println("===== EJERCICIO 5: PROMEDIO DE CONSUMO =====");
		...
		System.out.println(" EJERCICIO 6 Y 7: PRIMER GOLPE Y FATIGA ");

		primerGolpe(p1, p2, at1);

		System.out.println(" EJERCICIO 8: DESCANSO TACTICO ");
		descansoTactico(p1);

		System.out.println(" EJERCICIO 9: FILTRADO DE HABILIDADES ");
		...
		System.out.println(" EJERCICIO 10: COMBATE A MUERTE ");

		while (p1.getPuntosVida() > 0 && p2.getPuntosVida() > 0) {

			if (p1.getEnergia() <= 0 && p2.getEnergia() <= 0) {

				System.out.println("Ambos peleadores se quedaron sin energía.");
				break;
			...
			if (p1.getEnergia() > 0) {
				...
				primerGolpe(p1, p2, p1.getAtaqueDelPeleador().get(0));
			...
			if (p2.getEnergia() > 0) {
				...
				primerGolpe(p2, p1, p2.getAtaqueDelPeleador().get(0));

			}

			System.out.println(p1.getNombre() + " vida: " + p1.getPuntosVida());

			System.out.println(p2.getNombre() + " vida: " + p2.getPuntosVida());

			System.out.println("----------------------------");
		}

		if (p1.getPuntosVida() > p2.getPuntosVida()) {

			System.out.println(p1.getNombre() + " ganó el combate.");

		} else if (p2.getPuntosVida() > p1.getPuntosVida()) {

			System.out.println(p2.getNombre() + " ganó el combate.");
	...
	public static void primerGolpe(Peleador atacante, Peleador defensor, Ataque ataque) {
		if (atacante.getEnergia() >= ataque.getCostoEnergia()) {
			...
			if (defensor.getPuntosVida() < 0) {
				...
				defensor.setPuntosVida(0);

			}
			atacante.setEnergia(atacante.getEnergia() - ataque.getCostoEnergia());
			System.out.println(atacante.getNombre() + " ataca con " + ataque.getNombre() + " y causa " + danioTotal
					+ " de daño a " + defensor.getNombre());
			System.out.println(defensor.getNombre() + " tiene ahora " + defensor.getPuntosVida() + " puntos de vida y "
					+ atacante.getEnergia() + " de energía restante.");
		} else {
